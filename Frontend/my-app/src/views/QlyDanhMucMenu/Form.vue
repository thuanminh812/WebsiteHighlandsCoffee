      ...
      <div class="d-flex" id="wrapper">
          ...
          <div class="form-group">
            <label>Tên danh mục</label>
              <input class="form-control"  v-model="danhmucmenu.tenDanhMuc" required>
          </div>
          <div class="form-group">
            <label>Mô tả danh mục</label>
              <textarea style="resize: none; width: 100%;
  height: 150px;box-sizing: border-box;"  class="form-control"  v-model="danhmucmenu.motaDanhMuc" required></textarea>
          </div>
          <div>
    ...
    export default {
      ...
      save(){ 
          axios.post('https://localhost:7096/api/DanhMucMenu',this.danhmucmenu,this.getTokenConfig()).then(response => {
              if(response.data){
