  ...
  export default {
    ...
    methods:{
      decodeJwt(jwttoken){
        ...
        getMenu(id) {
          axios.get(`https://localhost:7096/api/Menu/${id}`).then(response => {
    ...
    save(){ 
      ...
      if(this.menu.idSanPham) {
          axios.put(`https://localhost:7096/api/Menu/${this.menu.idSanPham}`,this.menu,this.getTokenConfig()).then(response => {
