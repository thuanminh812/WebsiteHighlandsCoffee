      ...
      <div class="d-flex" id="wrapper">
          ...
          <div id="page-content-wrapper">
              <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                  <div class="d-flex align-items-center">
                      ...
                      <h2 class="fs-2 m-0">Thêm một tài khoản admin mới</h2>
                  </div>
          ...
          <div class="form-group">
            <label>Mật khẩu</label>
              <input type="password" class="form-control" v-model="register.password" required>
          </div>
          <div class="form-group">
            <label>Nhập lại mật khẩu</label>
              <input type="password" class="form-control" name="ten" v-model="register.confirmPassword" required>
          </div>
          <div>
    ...
    export default {
      ...
      methods:{
        decodeJwt(jwttoken){
          ...
          save(){
        axios.post('https://localhost:7096/api/Account/Register',this.register).then(response => {
              if(response.data){
