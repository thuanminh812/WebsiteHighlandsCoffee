<template>
    <div>
      <div class="d-flex" id="wrapper">
          ...
          <div id="page-content-wrapper">
              ...
              <button class="btn btn-info mb-3" style="margin-left:16px"><router-link to="formkhuvuc" class="text-white">Thêm mới</router-link></button>
        ...
        <tbody>
            <tr v-for="khuvuc in khuvucs" v-bind:key="khuvuc.idKhuVuc">
                <td>{{khuvuc.tenKhuVuc}}</td>
				<router-link :to="{ name: 'editkhuvuc', params: {id: khuvuc.idKhuVuc}}">
				<button class="btn btn-success"><i class="fa-solid fa-pen-to-square"></i></button> |
			</router-link>
				<button class="btn btn-danger" @click="onDelete(khuvuc.idKhuVuc)"><i class="fa-solid fa-trash"></i></button> |
        <router-link :to="{ name: 'listcuahang', params: {id: khuvuc.idKhuVuc}}">
  ...
  if (result.isConfirmed) {
	axios.delete(`https://localhost:7096/api/KhuVuc/${id}`,this.getTokenConfig()) .then(response => {
